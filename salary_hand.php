...
<html>
    <head>
       <link rel="stylesheet" type = "text/css" href = "active_salaryh.css">
    </head>
    
       <body>
    <section class = "body">
        
    <div class="heading"><h2>Salary in Hand Manager</h2></div>
     <div class = "second">
         
       
         <ul>
        <li><a href ="salary_hand.php" >Salary In Hand</a></li>
            ...
            if(mysqli_num_rows($query_sal)>0)
            {
                echo "<table>";
                    ...
                    while($row =mysqli_fetch_assoc($query_sal))
                    {
                      ...
                      echo "<td><a href ='trial.php?msg=".$row['ID']."'>Generate Pay Slip</a></td>";
                       echo "</tr>";
